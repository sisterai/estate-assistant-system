...
const { validateCreateCommuteProfile, validateUpdateCommuteProfile } = require('../src/validations/commute-profile.validation');
...
describe('CommuteProfileService', () => {
    ...
    describe('createProfile', () => {
        it('should throw validation error when data is invalid', async () => {
            ...
            // Act & Assert
            await expect(service.createProfile(userId, invalidData))
                .rejects
                .toThrow(AppError);
        });
    });
    ...
    describe('getProfilesByUserId', () => {
        it('should throw error for invalid user ID', async () => {
            ...
            // Act & Assert
            await expect(service.getProfilesByUserId(userId))
                .rejects
                .toThrow(AppError);
        });
    });
    ...
    describe('getProfileById', () => {
        it('should throw error for invalid profile ID', async () => {
            ...
            // Act & Assert
            await expect(service.getProfileById(profileId, userId))
                .rejects
                .toThrow(AppError);
        });
    ...
    describe('updateProfile', () => {
        it('should throw error for invalid validation', async () => {
            ...
            // Act & Assert
            await expect(service.updateProfile(profileId, userId, invalidData))
                .rejects
                .toThrow(AppError);
        });
        ...
        it('should throw error for invalid profile ID', async () => {
            ...
            validateUpdateCommuteProfile.mockReturnValue({ isValid: true, errors: [] });
            validateObjectId.mockReturnValue(false);

            // Act & Assert
            await expect(service.updateProfile(profileId, userId, validData))
                .rejects
                .toThrow(AppError);
        });
    ...
    describe('deleteProfile', () => {
        it('should throw error for invalid profile ID', async () => {
            ...
            // Act & Assert
            await expect(service.deleteProfile(profileId, userId))
                .rejects
                .toThrow(AppError);
        });
