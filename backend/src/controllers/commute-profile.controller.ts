...
import { CreateCommuteProfileDto, UpdateCommuteProfileDto } from "../dto/commute-profile.dto";
...
export const getCommuteProfiles = async (req: AuthRequest, res: Response) => {
    // Get profiles
    const profiles = await commuteProfileService.getProfilesByUserId(req.user?.id);
 ...
 */
export const getCommuteProfileById = async (req: AuthRequest, res: Response) => {
